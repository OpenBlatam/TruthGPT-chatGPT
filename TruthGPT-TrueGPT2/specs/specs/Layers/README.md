# Layers on AI
  ...
  Description: Creation of multimodal layer that performance the arquitecture of generative AI.
...
This document represents the specification for Phase 1 -- The Heuristic.
