...
def train_model(df: pd.DataFrame, model_type: str):
    ...
    # Using Dash for interactive plotting
    ...
    fig.add_trace(go.Scatter(x=test.index, y=preds, mode='lines', name='Prediction'))

    fig.update_layout(title='KPI over Time', xaxis_title='Date', yaxis_title='KPI')
