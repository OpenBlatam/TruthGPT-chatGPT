---
title: "Truthgpt Terminal Usage"
category: "Truthgpt"
tags: []
created: "2025-10-29"
path: "Truthgpt/truthgpt_terminal_usage.md"
---
...
### **Opción 2: Interfaz Final (Recomendada)**
```bash
...
```
🚀 TruthGPT Advanced Research - Final Interactive Interface
======================================================================
...
🤖 TruthGPT> /save
✅ Sesión guardada en: truthgpt_sessions/session_1760857880.json
...
**¡Ejecuta `python truthgpt_final.py` y comienza a usar TruthGPT ahora mismo!** 🚀💻🧠
