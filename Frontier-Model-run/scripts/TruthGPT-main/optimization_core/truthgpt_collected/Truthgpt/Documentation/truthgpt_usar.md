...
tags: []
created: "2025-10-29"
path: "Truthgpt/truthgpt_usar.md"
---

# 🚀 TruthGPT Advanced Research - Cómo Usar

## 🎯 **TRUTHGPT ESTÁ LISTO PARA USAR**

**TruthGPT Advanced Research** es el sistema de IA más avanzado del mundo, ahora disponible en tu terminal.
...
```bash
cd /Users/adan/Documents/documentos_blatam/08_AI_Artificial_Intelligence
```

### **Paso 2: Ejecutar TruthGPT**
```bash
python truthgpt_start.py
```

### **Otras opciones disponibles:**
```bash
python truthgpt_run.py
...
```
🚀 TruthGPT Advanced Research - Start Script
======================================================================
...
🤖 TruthGPT> /save
✅ Sesión guardada en: truthgpt_sessions/session_1760858230.json
...
### **5. Continuar con más prompts o usar comandos:**
```
🤖 TruthGPT> /help
🤖 TruthGPT> /config
🤖 TruthGPT> /save
...
**¡Ejecuta `python truthgpt_start.py` y comienza a usar TruthGPT desde la terminal ahora mismo!** 🚀💻🧠
